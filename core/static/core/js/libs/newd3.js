...
(function(t, n) {
    ...
    function d(t, n, e) {
        var r = Math.abs(n - t) / Math.max(0, e)
          ...
          , o = r / i;
        return o >= is ? i *= 10 : o >= os ? i *= 5 : o >= as && (i *= 2),
        n < t ? -i : i
    }
    function p(t) {
    ...
    function T(t, n) {
        function e(e) {
            ...
            N.attr(s + "2", c * a),
            S.attr(s, c * p).text(d),
            b.filter(A).attr("fill", "none").attr("font-size", 10).attr("font-family", "sans-serif").attr("text-anchor", t === cs ? "start" : t === ls ? "end" : "middle"),
            b.each(function() {
                this.__axis = _
            })
        }
        ...
        ,
        e.ticks = function() {
            return r = us.call(arguments),
            e
        }
        ,
        e.tickArguments = function(t) {
            return arguments.length ? (r = null == t ? [] : us.call(t),
            e) : r.slice()
        }
        ,
        e.tickValues = function(t) {
            return arguments.length ? (i = null == t ? null : us.call(t),
            e) : i && i.slice()
        }
        ,
    ...
    function O(t, n, e, r, i, o, a) {
        ...
        for (u = 0; u < l; ++u)
            (f = n[u]) && (d[u] = c = ms + a.call(f, f.__data__, u, n),
            c in s ? i[u] = f : s[c] = f);
        for (u = 0; u < h; ++u)
            (f = s[c = ms + a.call(t, o[u], u, o)]) ? (r[u] = f,
            f.__data__ = o[u],
            s[c] = null) : e[u] = new U(t,o[u]);
        for (u = 0; u < l; ++u)
            (f = n[u]) && s[d[u]] === f && (i[u] = f)
    }
    function Y(t, n) {
    ...
    function _t(t) {
        ...
        "onselectstart"in n ? e.on("selectstart.drag", yt, !0) : (n.__noselect = n.style.MozUserSelect,
        n.style.MozUserSelect = "none")
    }
    function bt(t, n) {
        var e = t.document.documentElement
          , r = ct(t).on("dragstart.drag", null);
        n && (r.on("click.drag", yt, !0),
        setTimeout(function() {
    ...
    function kt(t) {
        ...
        (n = Ss.exec(t)) ? (n = parseInt(n[1], 16),
        new Lt(n >> 8 & 15 | n >> 4 & 240,n >> 4 & 15 | 240 & n,(15 & n) << 4 | 15 & n,1)) : (n = Es.exec(t)) ? Ct(parseInt(n[1], 16)) : (n = ks.exec(t)) ? new Lt(n[1],n[2],n[3],1) : (n = Cs.exec(t)) ? new Lt(255 * n[1] / 100,255 * n[2] / 100,255 * n[3] / 100,1) : (n = Ps.exec(t)) ? Pt(n[1], n[2], n[3], n[4]) : (n = zs.exec(t)) ? Pt(255 * n[1] / 100, 255 * n[2] / 100, 255 * n[3] / 100, n[4]) : (n = Rs.exec(t)) ? Ut(n[1], n[2] / 100, n[3] / 100, 1) : (n = Ls.exec(t)) ? Ut(n[1], n[2] / 100, n[3] / 100, n[4]) : Ds.hasOwnProperty(t) ? Ct(Ds[t]) : "transparent" === t ? new Lt(NaN,NaN,NaN,0) : null
    }
    function Ct(t) {
    ...
    function zt(t) {
        ...
        t ? (t = t.rgb(),
        new Lt(t.r,t.g,t.b,t.opacity)) : new Lt
    }
    function Rt(t, n, e, r) {
    ...
    function Bt(t) {
        ...
        return i === o && o === a ? e = r = u : (e = jt((.4360747 * i + .3850649 * o + .1430804 * a) / Os),
        r = jt((.0139322 * i + .0971045 * o + .7141733 * a) / Bs)),
    ...
    function Vt(t) {
        if (t instanceof Wt)
            return new Wt(t.h,t.c,t.l,t.opacity);
        if (t instanceof It || (t = Bt(t)),
        0 === t.a && 0 === t.b)
    ...
    function dn(t, n) {
        var e, r = typeof n;
        return null == n || "boolean" === r ? nn(n) : ("number" === r ? sn : "string" === r ? (e = kt(n)) ? (n = e,
        rl) : hn : n instanceof kt ? rl : n instanceof Date ? cn : Array.isArray(n) ? fn : "function" != typeof n.valueOf && "function" != typeof n.toString || isNaN(n) ? ln : sn)(t, n)
    }
    function pn(t, n) {
        return t = +t,
        n -= t,
    ...
    function Nn() {
        ...
        ++wl;
        for (var t, n = nl; n; )
            (t = Sl - n._time) >= 0 && n._call.call(null, t),
            n = n._next;
        --wl
    }
    function Sn() {
    ...
    function kn(t) {
        if (!wl) {
            ...
            t - Sl > 24 ? (t < 1 / 0 && (Ml = setTimeout(Sn, t - kl.now() - El)),
            Al && (Al = clearInterval(Al))) : (Al || (Nl = kl.now(),
            Al = setInterval(En, Tl)),
            wl = 1,
            Cl(Sn))
        }
    }
    ...
    function Pn(t, n, e, r, i, o) {
        ...
        (function(t, n, e) {
            function r(f) {
                ...
                for (c in u)
                    if ((h = u[c]).name === e.name) {
                        if (h.state === Ul)
                            return Cn(r);
                        h.state === ql ? (h.state = Yl,
                        h.timer.stop(),
                        h.on.call("interrupt", t, t.__data__, h.index, h.group),
                        delete u[c]) : +c < n && (h.state = Yl,
                        h.timer.stop(),
                        delete u[c])
                    }
                if (Cn(function() {
                    e.state === Ul && (e.state = ql,
            ...
            function i(n) {
                ...
                e.state = Ol,
                1), i = -1, u = a.length; ++i < u; )
                    a[i].call(null, r);
                e.state === Ol && (e.on.call("end", t, t.__data__, e.index, e.group),
                o())
            }
            function o() {
                e.state = Yl,
    ...
    function Dn(t, n) {
        ...
        if (o) {
            n = null == n ? null : n + "";
            for (i in o)
                (e = o[i]).name === n ? (r = e.state > Dl && e.state < Ol,
                e.state = Yl,
                e.timer.stop(),
    ...
    function qn(t, n) {
        var e;
        return ("number" == typeof n ? sn : n instanceof kt ? rl : (e = kt(n)) ? (n = e,
        rl) : hn)(t, n)
    }
    function On(t, n, e, r) {
        this._groups = t,
    ...
    function ee(n) {
        ...
        function a() {
            ...
            function o() {
                ...
                case ph:
                case dh:
                    T && (y = Math.max(C - u, Math.min(z - d, y)),
                    c = u + y,
                    p = d + y),
                    N && (_ = Math.max(P - l, Math.min(R - v, _)),
                    h = l + _,
                    g = v + _);
                    break;
                case vh:
                    T < 0 ? (y = Math.max(C - u, Math.min(z - u, y)),
                    c = u + y,
                    p = d) : T > 0 && (y = Math.max(C - d, Math.min(z - d, y)),
                    c = u,
                    p = d + y),
                    N < 0 ? (_ = Math.max(P - l, Math.min(R - l, _)),
                    h = l + _,
                    g = v) : N > 0 && (_ = Math.max(P - v, Math.min(R - v, _)),
                    h = l,
                    g = v + _);
                    break;
                case gh:
                    T && (c = Math.max(C, Math.min(z, u - y * T)),
                    p = Math.max(C, Math.min(z, d + y * T))),
                    N && (h = Math.max(P, Math.min(R, l - _ * N)),
                ...
                x && (h = k[0][1],
                g = k[1][1]),
                k[0][0] === c && k[0][1] === h && k[1][0] === p && k[1][1] === g || (S.selection = [[c, h], [p, g]],
                r.call(w),
                q.brush())
            }
            function a() {
            ...
            if (s.apply(this, arguments)) {
                var u, c, l, h, d, p, v, g, y, _, b, m, x, w = this, M = t.event.target.__data__.type, A = "selection" === (t.event.metaKey ? M = "overlay" : M) ? dh : t.event.altKey ? gh : vh, T = n === _h ? null : Mh[M], N = n === yh ? null : Ah[M], S = te(w), E = S.extent, k = S.selection, C = E[0][0], P = E[0][1], z = E[1][0], R = E[1][1], L = T && N && t.event.shiftKey, D = pt(w), U = D, q = i(w, arguments).beforestart();
                "overlay" === M ? S.selection = k = [[u = n === _h ? C : D[0], l = n === yh ? P : D[1]], [d = n === _h ? z : u, v = n === yh ? R : l]] : (u = k[0][0],
                l = k[0][1],
                d = k[1][0],
                v = k[1][1]),
                c = u,
                ...
                if (t.event.touches)
                    ...
                    var B = ct(t.event.view).on("keydown.brush", function() {
                        ...
                        case 16:
                            ...
                            break;
                        case 18:
                            A === gh && (T < 0 ? d = p : T > 0 && (u = c),
                            N < 0 ? v = g : N > 0 && (l = h),
                            A = vh,
                            o());
                            break;
                        case 32:
                            A === ph && (t.event.altKey ? (T && (d = p - y * T,
                            u = c + y * T),
                            N && (v = g - _ * N,
                            l = h + _ * N),
                            A = gh) : (T < 0 ? d = p : T > 0 && (u = c),
        ...
        e.extent = function(t) {
            return arguments.length ? (c = "function" == typeof t ? t : $n([[+t[0][0], +t[0][1]], [+t[1][0], +t[1][1]]]),
            e) : c
        }
        ,
        e.filter = function(t) {
            return arguments.length ? (s = "function" == typeof t ? t : $n(!!t),
            e) : s
        }
        ,
    ...
    function Me() {
        ...
        function n(t, n) {
            ...
            return function(t, n, r) {
                function a(t) {
                    ...
                    (n = p[c]) ? (i = d[s]) ? (delete p[n.end],
                    delete d[i.start],
                    n === i ? (n.ring.push(a),
                    r(n.ring)) : d[n.start] = p[i.end] = {
                        start: n.start,
                        end: i.end,
                        ring: n.ring.concat(i.ring)
                    }) : (delete p[n.end],
                    n.ring.push(a),
                    p[n.end = s] = n) : (n = d[s]) ? (i = p[c]) ? (delete d[n.start],
                    delete p[i.end],
                    n === i ? (n.ring.push(a),
                    r(n.ring)) : d[i.start] = p[n.end] = {
                        start: i.start,
                        end: n.end,
                        ring: i.ring.concat(n.ring)
                    }) : (delete d[n.start],
                    n.ring.unshift(o),
                    d[n.start = c] = n) : d[c] = p[s] = {
                        start: c,
                        end: s,
                        ring: [o, a]
                    }
        ...
        function r(t, n, e) {
            t.forEach(function(t) {
                ...
                a > 0 && a < i && f === a && (r = n[c * i + f - 1],
                t[0] = a + (e - r) / (s - r) - .5),
                u > 0 && u < o && c === u && (r = n[(c - 1) * i + f],
                t[1] = u + (e - r) / (s - r) - .5)
            })
        }
        var i = 1
        ...
        t.thresholds = function(n) {
            return arguments.length ? (a = "function" == typeof n ? n : Array.isArray(n) ? me(Uh.call(n)) : me(n),
            t) : a
        }
        ,
        t.smooth = function(n) {
            return arguments.length ? (f = n ? r : we,
            t) : f === r
        }
        ,
        t
    ...
    function ke(t) {
        function n(t, n) {
            function e() {
                ...
                if (t.charCodeAt(r) === Bh) {
                    for (; u++ < a && t.charCodeAt(u) !== Bh || t.charCodeAt(++u) === Bh; )
                        ;
                    return (n = u) >= a ? c = !0 : (e = t.charCodeAt(u++)) === Fh ? s = !0 : e === Ih && (s = !0,
                    t.charCodeAt(u) === Fh && ++u),
                    t.slice(r + 1, n - 1).replace(/""/g, '"')
                }
                for (; u < a; ) {
                    if ((e = t.charCodeAt(n = u++)) === Fh)
                        s = !0;
                    else if (e === Ih)
                        s = !0,
                        t.charCodeAt(u) === Fh && ++u;
            ...
            for (t.charCodeAt(a - 1) === Fh && --a,
            t.charCodeAt(a - 1) === Ih && --a; (r = e()) !== Yh; ) {
                for (var l = []; r !== Oh && r !== Yh; )
                    l.push(r),
                    r = e();
    ...
    function ir(t) {
        function n(t) {
            function n(t) {
                ...
                switch (d && l && (t = e(A + t, A.length ? h - x.length : 1 / 0),
                A = ""),
                f) {
                case "<":
                    t = s + t + x + A;
            ...
            var y = "$" === s ? r[0] : "#" === s && /[boxX]/.test(g) ? "0" + g.toLowerCase() : ""
              ...
              , b = sd[g]
              , m = /[defgprs%]/.test(g);
            return p = null == p ? 6 : /[gprs]/.test(g) ? Math.max(1, Math.min(21, p)) : Math.max(0, Math.min(20, p)),
            n.toString = function() {
                return t + ""
            }
            ,
        ...
        var e = t.grouping && t.thousands ? function(t, n) {
            return function(e, r) {
                for (var i = e.length, o = [], a = 0, u = t[0], f = 0; i > 0 && u > 0 && (f + u + 1 > r && (u = Math.max(1, r - f)),
    ...
    function zr(t, n) {
        ...
        if (Ad) {
            ...
            c ^ (u * xd < f && f < u * t) ? (o = i[1] * Zd) > md && (md = o) : (f = (f + 360) % 360 - 180,
            c ^ (u * xd < f && f < u * t) ? (o = -i[1] * Zd) < _d && (_d = o) : (n < _d && (_d = n),
            n > md && (md = n))),
            c ? t < xd ? Or(yd, t) > Or(yd, bd) && (bd = t) : Or(t, bd) > Or(yd, bd) && (yd = t) : bd >= yd ? (t < yd && (yd = t),
            t > bd && (bd = t)) : t > xd ? Or(yd, t) > Or(yd, bd) && (bd = t) : Or(t, bd) > Or(yd, bd) && (yd = t)
        } else
            Td.push(Nd = [yd = t, bd = t]);
        n < _d && (_d = n),
        n > md && (md = n),
    ...
    function ni(t) {
        return function(n, e) {
            return n += t,
            [n > Gd ? n - Wd : n < -Gd ? n + Wd : n, e]
        }
    }
    function ei(t) {
        var n = ni(t);
        return n.invert = ni(-t),
        n
    }
    function ri(t, n) {
        function e(t, n) {
    ...
    function ii(t) {
        function n(n) {
            return n = t(n[0] * Qd, n[1] * Qd),
            n[0] *= Zd,
            n[1] *= Zd,
            n
        }
        return t = ti(t[0] * Qd, t[1] * Qd, t.length > 2 ? t[2] * Qd : 0),
        n.invert = function(n) {
            return n = t.invert(n[0] * Qd, n[1] * Qd),
            n[0] *= Zd,
            n[1] *= Zd,
            n
        }
    ...
    function hi(t, n) {
        var e = n[0]
          ...
          , u = 0;
        kp.reset(),
        1 === i ? r = Vd + Hd : -1 === i && (r = -Vd - Hd);
        for (var f = 0, c = t.length; f < c; ++f)
            if (l = (s = t[f]).length)
                for (var s, l, h = s[l - 1], d = h[0], p = h[1] / 2 + $d, v = ap(p), g = np(p), y = 0; y < l; ++y,
                d = b,
                v = x,
                g = w,
                h = _) {
                    var _ = s[y]
                      ...
                      , N = T > Gd
                      , S = v * x;
                    if (kp.add(tp(S * A * ap(T), g * w + S * np(T))),
                    a += N ? M + A * Wd : M,
                    N ^ d >= e ^ b >= e) {
                        var E = Sr(Tr(h), Tr(_));
                        Cr(E);
        ...
        return function(i) {
            ...
            var h, d, p, v = n(i), g = ui(), _ = n(g), b = !1, m = {
                ...
                polygonEnd: function() {
                    ...
                    d = y(d);
                    var t = hi(h, r);
                    d.length ? (b || (i.polygonStart(),
                    b = !0),
                    si(d, vi, t, e, i)) : t && (b || (i.polygonStart(),
                    b = !0),
                    i.lineStart(),
                    e(null, null, 1, i),
                    i.lineEnd()),
        ...
        return di(n, function(t) {
            ...
            return {
                ...
                point: function(l, h) {
                    ...
                    if (!i && (c = f = v) && t.lineStart(),
                    v !== f && (!(d = e(i, p)) || fi(i, d) || fi(p, d)) && (p[0] += Hd,
                    p[1] += Hd,
                    v = n(p[0], p[1])),
                    v !== f)
                        s = 0,
        ...
        return +n ? function(t, n) {
            function e(r, i, o, a, u, f, c, s, l, h, d, p, v, g) {
                ...
                if (b > 4 * n && v--) {
                    var m = a + h
                      ...
                      , C = E - i
                      , P = _ * k - y * C;
                    (P * P / b > n || Jd((y * k + _ * C) / b - .5) > .3 || a * h + u * d + f * p < lv) && (e(r, i, o, a, u, f, S, E, T, m /= M, x /= M, w, v, g),
                    g.point(S, E),
            ...
            return function(n) {
                ...
                function o(r, i) {
                    var o = Tr([r, i])
                      , a = t(r, i);
                    e(y, _, g, b, m, x, y = a[0], _ = a[1], g = r, b = o[0], m = o[1], x = o[2], sv, n),
                    n.point(y, _)
                }
                function a() {
                    w.point = r,
    ...
    function uo(t) {
        ...
        var i, o, a, u, f, c, s, l, h, d, p = 150, v = 480, g = 250, y = 0, _ = 0, b = 0, m = 0, x = 0, w = 0, M = null, A = Cp, T = null, N = zi, S = .5;
        ...
        n.clipAngle = function(t) {
            return arguments.length ? (A = +t ? gi(M = t * Qd) : (M = null,
            Cp),
            r()) : M * Zd
        }
        ,
        n.clipExtent = function(t) {
            return arguments.length ? (N = null == t ? (T = a = u = f = null,
            zi) : yi(T = +t[0][0], a = +t[0][1], u = +t[1][0], f = +t[1][1]),
            r()) : null == T ? null : [[T, a], [u, f]]
        }
        ,
        n.scale = function(t) {
        ...
        ,
        n.center = function(t) {
            return arguments.length ? (y = t[0] % 360 * Qd,
            _ = t[1] % 360 * Qd,
            e()) : [y * Zd, _ * Zd]
        }
        ,
        n.rotate = function(t) {
            return arguments.length ? (b = t[0] % 360 * Qd,
            m = t[1] % 360 * Qd,
        ...
        ,
        n.angle = function(t) {
            return arguments.length ? (w = t % 360 * Qd,
            e()) : w * Zd
        }
        ,
        n.precision = function(t) {
            return arguments.length ? (c = io(s, S = t * t),
            r()) : fp(S)
        }
        ,
    ...
    function go(t) {
        ...
        o.clipExtent = function(t) {
            return arguments.length ? (null == t ? s = e = r = i = null : (s = +t[0][0],
            e = +t[0][1],
            r = +t[1][0],
            i = +t[1][1]),
            n()) : null == s ? null : [[s, e], [r, i]]
        }
        ,
        n()
    }
    ...
    function Uo(t) {
        for (var n, e, r = 0, i = (t = function(t) {
            for (var n, e, r = t.length; r; )
                ...
                t[e] = n;
            return t
        }(vv.call(t))).length, o = []; r < i; )
            n = t[r],
            e && Oo(e, n) ? ++r : (e = function(t) {
                switch (t.length) {
                case 1:
                    return function(t) {
                        return {
    ...
    function ga(t) {
        ...
        ,
        n.range = function(e) {
            return arguments.length ? (t = Cv.call(e),
            n) : t.slice()
        }
        ,
    ...
    function ya() {
        ...
        r.padding = function(n) {
            return arguments.length ? (f = c = Math.max(0, Math.min(1, n)),
            t()) : f
        }
        ,
    ...
    function Ta(t, n) {
        function e() {
            return i = Math.min(u.length, f.length) > 2 ? Ma : wa,
            o = a = null,
            r
        }
        function r(n) {
        ...
        ,
        r.domain = function(t) {
            return arguments.length ? (u = kv.call(t, ma),
            e()) : u.slice()
        }
        ,
        r.range = function(t) {
            return arguments.length ? (f = Cv.call(t),
            e()) : f.slice()
        }
        ,
        ...
        n.tickFormat = function(n, r) {
            return function(n, e, r) {
                ...
                case "s":
                    ...
                    return null != r.precision || isNaN(i = ur(u, f)) || (r.precision = i),
                    t.formatPrefix(r, f);
                case "":
                case "e":
                case "g":
    ...
    function Ea() {
        ...
        t.domain = t.range = function(e) {
            return arguments.length ? (n = kv.call(e, ma),
            t) : n.slice()
        }
        ,
        t.copy = function() {
    ...
    function Ya() {
        ...
        ,
        e.range = function(n) {
            return arguments.length ? (i = Cv.call(n),
            t()) : i.slice()
        }
        ,
    ...
    function Ba() {
        ...
        ,
        t.range = function(t) {
            return arguments.length ? (i = (a = Cv.call(t)).length - 1,
            n()) : a.slice()
        }
        ,
    ...
    function Fa() {
        ...
        return t.domain = function(i) {
            return arguments.length ? (n = Cv.call(i),
            r = Math.min(n.length, e.length - 1),
            t) : n.slice()
        }
        ,
        t.range = function(i) {
            return arguments.length ? (e = Cv.call(i),
            r = Math.min(n.length, e.length - 1),
            t) : e.slice()
        }
        ,
            ...
            return function(e) {
                ...
                "V"in a) {
                    if (a.V < 1 || a.V > 53)
                        return null;
                    "w"in a || (a.w = 1),
                    "Z"in a ? (i = (o = (i = Ga(Va(a.y))).getUTCDay()) > 4 || 0 === o ? _g.ceil(i) : _g(i),
                    i = vg.offset(i, 7 * (a.V - 1)),
                    a.y = i.getUTCFullYear(),
                    a.m = i.getUTCMonth(),
                    a.d = i.getUTCDate() + (a.w + 6) % 7) : (i = (o = (i = n(Va(a.y))).getDay()) > 4 || 0 === o ? $v.ceil(i) : $v(i),
                    ...
                    o = "Z"in a ? Ga(Va(a.y)).getUTCDay() : n(Va(a.y)).getDay(),
                    a.m = 0,
        ...
        var i = t.dateTime
          ...
          , A = {
            ...
            b: function(t, n, e) {
                ...
                return r ? (t.m = x[r[0].toLowerCase()],
                e + r[0].length) : -1
            },
            B: function(t, n, e) {
            ...
            p: function(t, n, e) {
                ...
                return r ? (t.p = d[r[0].toLowerCase()],
                e + r[0].length) : -1
            },
            Q: gu,
            s: yu,
    ...
    function ku(t, n) {
        var e = t.getDay();
        return t = e >= 4 || 0 === e ? Qv(t) : Qv.ceil(t),
    ...
    function Gu(t, n) {
        var e = t.getUTCDay();
        return t = e >= 4 || 0 === e ? xg(t) : xg.ceil(t),
    ...
    function of(t, n, r, i, o, a, u, f, c) {
        ...
        function l(n, r, i, o) {
            ...
            "number" == typeof n) {
                ...
                u === A.length ? (o = d(r / Wg, i / Wg, n),
                n = t) : u ? (o = (u = A[a / A[u - 1][2] < A[u][2] / a ? u - 1 : u])[1],
                n = u[0]) : (o = Math.max(d(r, i, n), 1),
                n = f)
            }
    ...
    function Mf() {
        function t(t) {
            ...
            for (null == i && (a = o(c = oe())),
            u = 0; u <= s; ++u)
                !(u < s && r(f = t[u], u, t)) === l && ((l = !l) ? a.lineStart() : a.lineEnd()),
        ...
        return t.x = function(e) {
            return arguments.length ? (n = "function" == typeof e ? e : lf(+e),
            t) : n
        }
        ,
        t.y = function(n) {
            return arguments.length ? (e = "function" == typeof n ? n : lf(+n),
            t) : e
        }
        ,
        t.defined = function(n) {
            return arguments.length ? (r = "function" == typeof n ? n : lf(!!n),
            t) : r
        }
        ,
        t.curve = function(n) {
    ...
    function Af() {
        ...
        ,
        t.x1 = function(n) {
            return arguments.length ? (r = null == n ? null : "function" == typeof n ? n : lf(+n),
            t) : r
        }
        ,
        t.y = function(n) {
            return arguments.length ? (i = "function" == typeof n ? n : lf(+n),
            o = null,
            t) : i
        }
        ,
        ...
        ,
        t.y1 = function(n) {
            return arguments.length ? (o = null == n ? null : "function" == typeof n ? n : lf(+n),
            t) : o
        }
        ,
        ...
        ,
        t.defined = function(n) {
            return arguments.length ? (a = "function" == typeof n ? n : lf(!!n),
            t) : a
        }
        ,
        t.curve = function(n) {
        ...
        ,
        t.context = function(n) {
            return arguments.length ? (null == n ? u = c = null : c = f(u = n),
            t) : u
        }
        ,
        t
    ...
    function Df(t) {
        function n() {
            ...
            if (a || (a = n = oe()),
            t(a, +i.apply(this, (u[0] = f,
            u)), +o.apply(this, u), +i.apply(this, (u[0] = c,
            u)), +o.apply(this, u)),
            n)
                return a = null,
                n + "" || null
        ...
        ,
        n.x = function(t) {
            return arguments.length ? (i = "function" == typeof t ? t : lf(+t),
            n) : i
        }
        ,
        n.y = function(t) {
            return arguments.length ? (o = "function" == typeof t ? t : lf(+t),
            n) : o
        }
        ,
    ...
    function Dc(t) {
        var n = t.circle
          ...
          , u = [t];
        Lc(t);
        for (var f = o; f.circle && Math.abs(e - f.circle.x) < ab && Math.abs(r - f.circle.cy) < ab; )
            o = f.P,
            u.unshift(f),
            Lc(f),
            f = o;
        u.unshift(f),
        zc(f);
        for (var c = a; c.circle && Math.abs(e - c.circle.x) < ab && Math.abs(r - c.circle.cy) < ab; )
            a = c.N,
            u.push(c),
            Lc(c),
            c = a;
        ...
        n) {
            ...
            (function(t, n, e, r) {
                for (var i, o = rb.length; o--; )
                    Sc(i = rb[o], t, n, e, r) && Nc(i, t, n, e, r) && (Math.abs(i[0][0] - i[1][0]) > ab || Math.abs(i[0][1] - i[1][1]) > ab) || delete rb[o]
            }
            )(a, u, f, c),
            function(t, n, e, r) {
                ...
                for (i = 0; i < g; ++i)
                    if (o = nb[i]) {
                        ...
                        c = f.length; u < c; )
                            ...
                            l = (s = kc(o, rb[f[++u % c]]))[0],
                            h = s[1],
                            (Math.abs(p - l) > ab || Math.abs(v - h) > ab) && (f.splice(u, 0, rb.push(Ac(a, d, Math.abs(p - t) < ab && r - v > ab ? [t, Math.abs(l - t) < ab ? h : r] : Math.abs(v - r) < ab && e - p > ab ? [Math.abs(h - r) < ab ? l : e, r] : Math.abs(p - e) < ab && v - n > ab ? [e, Math.abs(l - e) < ab ? h : n] : Math.abs(v - n) < ab && p - t > ab ? [Math.abs(h - n) < ab ? l : t, n] : null)) - 1),
                            ++c);
                        c && (y = !1)
                    }
                if (y) {
                    ...
                    for (i = 0,
                    y = null; i < g; ++i)
                        (o = nb[i]) && (m = (_ = (a = o.site)[0] - t) * _ + (b = a[1] - n) * b) < x && (x = m,
                        y = o);
                    if (y) {
                        var w = [t, n]
                          , M = [t, r]
    ...
    Nt(It, Ft, St(Et, {
        ...
        rgb: function() {
            ...
            t = Ys * Ht(t),
            e = Bs * Ht(e),
            new Lt(Xt(3.1338561 * n - 1.6168667 * t - .4906146 * e),Xt(-.9787684 * n + 1.9161415 * t + .033454 * e),Xt(.0719453 * n - .2289914 * t + 1.4052427 * e),this.opacity)
        }
    })),
    Nt(Wt, $t, St(Et, {
        brighter: function(t) {
    ...
    var Qs, Js, Ks, tl, nl, el, rl = function t(n) {
        ...
        return e.gamma = t,
        e
    }(1), il = un(Kt), ol = un(tn), al = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g, ul = new RegExp(al.source,"g"), fl = 180 / Math.PI, cl = {
        translateX: 0,
        translateY: 0,
        rotate: 0,
        skewX: 0,
        ...
        return "none" === t ? cl : (Qs || (Qs = document.createElement("DIV"),
        ...
        return null == t ? cl : (tl || (tl = document.createElementNS("http://www.w3.org/2000/svg", "g")),
        tl.setAttribute("transform", t),
        (t = tl.transform.baseVal.consolidate()) ? (t = t.matrix,
        vn(t.a, t.b, t.c, t.d, t.e, t.f)) : cl)
    }, ", ", ")", ")"), hl = Math.SQRT2, dl = 2, pl = 4, vl = 1e-12, gl = bn(rn), yl = bn(an), _l = mn(rn), bl = mn(an), ml = xn(rn), xl = xn(an), wl = 0, Ml = 0, Al = 0, Tl = 1e3, Nl = 0, Sl = 0, El = 0, kl = "object" == typeof performance && performance.now ? performance : Date, Cl = "object" == typeof window && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(t) {
        setTimeout(t, 17)
    }
    ;
    An.prototype = Tn.prototype = {
        ...
        restart: function(t, n, e) {
            ...
            this._next || el === this || (el ? el._next = this : nl = this,
            el = this),
            this._call = t,
            this._time = e,
            kn()
    ...
    ie.prototype = oe.prototype = {
        ...
        arc: function(t, n, e, r, i, o) {
            ...
            e && (l < 0 && (l = l % Rh + Rh),
            l > Lh ? this._ += "A" + e + "," + e + ",0,1," + s + "," + (t - a) + "," + (n - u) + "A" + e + "," + e + ",0,1," + s + "," + (this._x1 = f) + "," + (this._y1 = c) : l > 1e-6 && (this._ += "A" + e + "," + e + ",0," + +(l >= zh) + "," + s + "," + (this._x1 = t + e * Math.cos(i)) + "," + (this._y1 = n + e * Math.sin(i))))
        },
    ...
    , fp = Math.sqrt, cp = Math.tan, sp = {
        ...
        polygonEnd: function() {
            ...
            gp.lineEnd = Lr,
            hp < 0 ? (yd = -(bd = 180),
            _d = -(md = 90)) : vp > Hd ? md = 90 : vp < -Hd && (_d = -90),
            Nd[0] = yd,
            Nd[1] = bd
        }
    }, yp = {
    ...
    var _p, bp, mp, xp, wp, Mp, Ap, Tp, Np, Sp, Ep, kp = cr(), Cp = di(function() {
        ...
        return {
            ...
            point: function(o, a) {
                var u = o > 0 ? Gd : -Gd
                  , f = Jd(o - e);
                Jd(f - Gd) < Hd ? (t.point(e, r = (r + a) / 2 > 0 ? Vd : -Vd),
                t.point(i, r),
                t.lineEnd(),
                t.lineStart(),
                t.point(u, r),
                t.point(o, r),
                n = 0) : i !== u && f >= Gd && (Jd(e - i) < Hd && (e -= i * Hd),
                Jd(o - u) < Hd && (o -= u * Hd),
                r = function(t, n, e, r) {
                    var i, o, a = ap(t - e);
        ...
        result: function() {
            ...
            return Vp = $p = Wp = Zp = Qp = Jp = Kp = tv = nv = 0,
            t
        }
    };
    Gi.prototype = {
    ...
    Mo.invert = function(t, n) {
        ...
        } while (Jd(e) > Hd && --i > 0);return [t / (.8707 + (o = r * r) * (o * (o * o * o * (.003971 - .001529 * o) - .013791) - .131979)), r]
    }
    ,
    Ao.invert = po(dr),
        ...
        function e(t, e, r, i, o) {
            if ((a = t._squarify) && a.ratio === n)
                for (var a, u, f, c, s, l = -1, h = a.length, d = t.value; ++l < h; ) {
                    ...
                    s = f.length; c < s; ++c)
                        u.value += f[c].value;
                    u.dice ? na(u, e, r, i, r += (o - r) * u.value / d) : sa(u, e, r, e += (i - e) * u.value / d, o),
                    d -= u.value
                }
            else
                t._squarify = a = la(n, t, e, r, i, o),
                a.ratio = n
        }
        return e.ratio = function(n) {
            return t((n = +n) > 1 ? n : 1)
    ...
    var E_ = Array.prototype.slice
      ...
      , H_ = {
        draw: function(t, n) {
            ...
            t.lineTo(o, a),
            t.lineTo(u, f),
            t.lineTo(-.5 * r - F_ * i, F_ * r + -.5 * i),
            t.lineTo(-.5 * o - F_ * a, F_ * o + -.5 * a),
            t.lineTo(-.5 * u - F_ * f, F_ * u + -.5 * f),
            t.lineTo(-.5 * r + F_ * i, -.5 * i - F_ * r),
            t.lineTo(-.5 * o + F_ * a, -.5 * a - F_ * o),
            t.lineTo(-.5 * u + F_ * f, -.5 * f - F_ * u),
            t.closePath()
        }
    }
        ...
        lineEnd: function() {
            ...
            if (e)
                ...
                2 === e)
                    ...
                    for (var r = fc(t), i = fc(n), o = 0, a = 1; a < e; ++o,
                    ++a)
    ...
    t.histogram = function() {
        ...
        return t.value = function(e) {
            return arguments.length ? (n = "function" == typeof e ? e : f(e),
            t) : n
        }
        ,
        t.domain = function(n) {
            return arguments.length ? (e = "function" == typeof n ? n : f([n[0], n[1]]),
            t) : e
        }
        ,
        t.thresholds = function(n) {
            return arguments.length ? (r = "function" == typeof n ? n : Array.isArray(n) ? f(es.call(n)) : f(n),
            t) : r
        }
        ,
        t
    ...
    t.chord = function() {
        function t(t) {
            var o, a, u, f, c, l, h = t.length, d = [], p = s(h), v = [], g = [], y = g.groups = new Array(h), _ = new Array(h * h);
            for (o = 0,
            c = -1; ++c < h; ) {
                for (a = 0,
                l = -1; ++l < h; )
        ...
        return t.padAngle = function(e) {
            return arguments.length ? (n = Ch(0, e),
            t) : n
        }
        ,
    ...
    t.ribbon = function() {
        function t() {
            var t, u = Ph.call(arguments), f = n.apply(this, u), c = e.apply(this, u), s = +r.apply(this, (u[0] = f,
            u)), l = i.apply(this, u) - Eh, h = o.apply(this, u) - Eh, d = s * Th(l), p = s * Nh(l), v = +r.apply(this, (u[0] = c,
            u)), g = i.apply(this, u) - Eh, y = o.apply(this, u) - Eh;
            if (a || (a = t = oe()),
            a.moveTo(d, p),
            a.arc(0, 0, s, l, h),
            l === g && h === y || (a.quadraticCurveTo(0, 0, v * Th(g), v * Nh(g)),
            a.arc(0, 0, v, g, y)),
        ...
        return t.radius = function(n) {
            return arguments.length ? (r = "function" == typeof n ? n : re(+n),
            t) : r
        }
        ,
        t.startAngle = function(n) {
            return arguments.length ? (i = "function" == typeof n ? n : re(+n),
            t) : i
        }
        ,
        t.endAngle = function(n) {
            return arguments.length ? (o = "function" == typeof n ? n : re(+n),
            t) : o
        }
        ,
        t.source = function(e) {
    ...
    t.contourDensity = function() {
        ...
        var a = Ne
          ...
          , _ = me(20);
        return t.x = function(n) {
            return arguments.length ? (a = "function" == typeof n ? n : me(+n),
            t) : a
        }
        ,
        t.y = function(n) {
            return arguments.length ? (u = "function" == typeof n ? n : me(+n),
            t) : u
        }
        ,
        t.size = function(t) {
        ...
        ,
        t.thresholds = function(n) {
            return arguments.length ? (_ = "function" == typeof n ? n : Array.isArray(n) ? me(Uh.call(n)) : me(n),
            t) : _
        }
        ,
    ...
    t.drag = function() {
        ...
        function o() {
            if (d.apply(this, arguments)) {
                ...
                for (n = 0; n < o; ++n)
                    (e = f(r[n].identifier, i, vt, this, arguments)) && (gt(),
                    e("start"))
            }
        }
        function a() {
        ...
        n.clickDistance = function(t) {
            return arguments.length ? (m = (t = +t) * t,
            n) : Math.sqrt(m)
        }
        ,
        n
    ...
    t.forceCollide = function(t) {
        ...
        var i, o, a = 1, u = 1;
        return "function" != typeof t && (t = qe(null == t ? 1 : +t)),
        ...
        ,
        n.radius = function(e) {
            return arguments.length ? (t = "function" == typeof e ? e : qe(+e),
            r(),
            n) : t
        }
        ,
    ...
    t.forceLink = function(t) {
        ...
        function e() {
            if (u) {
                ...
                c = new Array(h); n < h; ++n)
                    e = t[n],
                    c[n] = f[e.source.index] / (f[e.source.index] + f[e.target.index]);
                o = new Array(h),
                r(),
                a = new Array(h),
                i()
        ...
        n.distance = function(t) {
            return arguments.length ? (h = "function" == typeof t ? t : qe(+t),
            i(),
            n) : h
        }
        ,
    ...
    t.forceManyBody = function() {
        ...
        function e(t) {
            ...
            if (t.length) {
                for (r = i = o = 0; o < 4; ++o)
                    (n = t[o]) && (e = Math.abs(n.value)) && (a += n.value,
                    f += e,
                    r += e * n.x,
                    i += e * n.y);
                t.x = r / f,
        ...
        function r(t, n, e, r) {
            ...
            if (h * h / l < d)
                ...
                !0;
            if (!(t.length || d >= s)) {
                (t.data !== o || t.next) && (0 === i && (i = Oe(),
                d += i * i),
                0 === f && (f = Oe(),
                d += f * f),
                d < c && (d = Math.sqrt(c * d)));
                do {
                    t.data !== o && (h = u[t.data.index] * a / d,
                    o.vx += i * h,
                    o.vy += f * h)
                } while (t = t.next)
            }
        ...
        t.strength = function(e) {
            return arguments.length ? (f = "function" == typeof e ? e : qe(+e),
            n(),
            t) : f
        }
        ,
    ...
    t.forceRadial = function(t, n, e) {
        ...
        var o, a, u, f = qe(.1);
        return "function" != typeof t && (t = qe(+t)),
        null == n && (n = 0),
        null == e && (e = 0),
        ...
        r.strength = function(t) {
            return arguments.length ? (f = "function" == typeof t ? t : qe(+t),
            i(),
            r) : f
        }
        ,
        r.radius = function(n) {
            return arguments.length ? (t = "function" == typeof n ? n : qe(+n),
            i(),
            r) : t
        }
        ,
    ...
    t.forceSimulation = function(t) {
        ...
        function e() {
            ...
            n = 0; n < r; ++n)
                null == (e = t[n]).fx ? e.x += e.vx *= s : (e.x = e.fx,
                e.vx = 0),
                null == e.fy ? e.y += e.vy *= s : (e.y = e.fy,
                e.vy = 0)
        }
        function r() {
    ...
    t.forceX = function(t) {
        ...
        var r, i, o, a = qe(.1);
        return "function" != typeof t && (t = qe(null == t ? 0 : +t)),
        n.initialize = function(t) {
            r = t,
            e()
        }
        ,
        n.strength = function(t) {
            return arguments.length ? (a = "function" == typeof t ? t : qe(+t),
            e(),
            n) : a
        }
        ,
        n.x = function(r) {
            return arguments.length ? (t = "function" == typeof r ? r : qe(+r),
            e(),
            n) : t
        }
        ,
    ...
    t.geoBounds = function(t) {
        ...
        e = Td.length) {
            ...
            n = 1,
            o = [r = Td[0]]; n < e; ++n)
                Br(r, (i = Td[n])[0]) || Br(r, i[1]) ? (Or(r[0], i[1]) > Or(r[0], r[1]) && (r[1] = i[1]),
                Or(i[0], r[1]) > Or(r[0], r[1]) && (r[0] = i[0])) : o.push(r = i);
            for (a = -1 / 0,
            n = 0,
        ...
        return Td = Nd = null,
        yd === 1 / 0 || _d === 1 / 0 ? [[NaN, NaN], [NaN, NaN]] : [[yd, _d], [bd, md]]
    }
    ,
    t.geoCentroid = function(t) {
        ...
        e = Cd,
        r = Pd),
        (i = n * n + e * e + r * r) < Xd) ? [NaN, NaN] : [tp(e, n) * Zd, dr(r / fp(i)) * Zd]
    }
    ,
    t.geoCircle = function() {
        ...
        return t.center = function(n) {
            return arguments.length ? (r = "function" == typeof n ? n : Qr([+n[0], +n[1]]),
            t) : r
        }
        ,
        t.radius = function(n) {
            return arguments.length ? (i = "function" == typeof n ? n : Qr(+n),
            t) : i
        }
        ,
        t.precision = function(n) {
            return arguments.length ? (o = "function" == typeof n ? n : Qr(+n),
            t) : o
        }
        ,
        t
    ...
    t.geoAlbersUsa = function() {
        ...
        var e, r, i, o, a, u, f = lo(), c = so().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]), s = so().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]), l = {
            point: function(t, n) {
                u = [t, n]
            }
        };
        ...
        ,
        t.scale = function(n) {
            return arguments.length ? (f.scale(n),
            c.scale(.35 * n),
            s.scale(n),
            t.translate(f.translate())) : f.scale()
        }
        ,
        t.translate = function(t) {
            ...
            o = c.translate([r - .307 * e, u + .201 * e]).clipExtent([[r - .425 * e + Hd, u + .12 * e + Hd], [r - .214 * e - Hd, u + .234 * e - Hd]]).stream(l),
            a = s.translate([r - .205 * e, u + .212 * e]).clipExtent([[r - .214 * e + Hd, u + .166 * e + Hd], [r - .115 * e - Hd, u + .234 * e - Hd]]).stream(l),
            n()
        }
        ,
    ...
    t.geoIdentity = function() {
        ...
        return a = {
            ...
            postclip: function(i) {
                return arguments.length ? (p = i,
                d = n = e = r = null,
                t()) : p
            },
            clipExtent: function(i) {
                return arguments.length ? (p = null == i ? (d = n = e = r = null,
                zi) : yi(d = +i[0][0], n = +i[0][1], e = +i[1][0], r = +i[1][1]),
                t()) : null == d ? null : [[d, n], [e, r]]
            },
            scale: function(n) {
                return arguments.length ? (h = wo((u = +n) * s, u * l, f, c),
                t()) : u
            },
            translate: function(n) {
                return arguments.length ? (h = wo(u * s, u * l, f = +n[0], c = +n[1]),
                t()) : [f, c]
            },
            reflectX: function(n) {
                return arguments.length ? (h = wo(u * (s = n ? -1 : 1), u * l, f, c),
                t()) : s < 0
            },
            reflectY: function(n) {
                return arguments.length ? (h = wo(u * s, u * (l = n ? -1 : 1), f, c),
                t()) : l < 0
            },
    ...
    t.pack = function() {
        function t(t) {
            return t.x = e / 2,
            t.y = r / 2,
            n ? t.eachBefore(Qo(n)).eachAfter(Jo(i, .5)).eachBefore(Ko(1)) : t.eachBefore(Qo(Zo)).eachAfter(Jo($o, 1)).eachAfter(Jo(i, t.r / Math.min(e, r))).eachBefore(Ko(Math.min(e, r) / (2 * t.r))),
            t
        }
        var n = null
          , e = 1
        ...
        t.padding = function(n) {
            return arguments.length ? (i = "function" == typeof n ? n : Wo(+n),
            t) : i
        }
        ,
        t
    ...
    t.stratify = function() {
        function t(t) {
            ...
            for (i = 0; i < s; ++i)
                r = t[i],
                u = l[i] = new Do(r),
                null != (f = n(r, i, t)) && (f += "") && (h[c = gv + (u.id = f)] = c in h ? _v : u);
            for (i = 0; i < s; ++i)
                if (u = l[i],
                null != (f = e(t[i], i, t)) && (f += "")) {
                    if (!(a = h[gv + f]))
    ...
    t.tree = function() {
                ...
                for (var n, e, r, i, o, a = new ca(t,0), u = [a]; n = u.pop(); )
                    if (r = n._.children)
                        ...
                        i = o - 1; i >= 0; --i)
                            ...
                            e.parent = n;
                return (a.parent = new ca(null,0)).children = [a],
                a
            }(t);
            if (f.eachAfter(n),
            f.parent.m = -f.z,
        ...
        function n(t) {
            ...
            t.parent.A = function(t, n, e) {
                if (n) {
                    for (var r, o = t, a = t, u = n, f = o.parent.children[0], c = o.m, s = a.m, l = u.m, h = f.m; u = aa(u),
                    o = oa(o),
                    u && o; )
                        f = oa(f),
                        (a = aa(a)).a = t,
                        (r = u.z + l - o.z - c + i(u._, o._)) > 0 && (ua(fa(u, t, e), t, r),
                        c += r,
                        s += r),
                        l += u.m,
                        c += o.m,
    ...
    t.treemap = function() {
        ...
        t.paddingInner = function(n) {
            return arguments.length ? (u = "function" == typeof n ? n : Wo(+n),
            t) : u
        }
        ,
        ...
        t.paddingTop = function(n) {
            return arguments.length ? (f = "function" == typeof n ? n : Wo(+n),
            t) : f
        }
        ,
        t.paddingRight = function(n) {
            return arguments.length ? (c = "function" == typeof n ? n : Wo(+n),
            t) : c
        }
        ,
        t.paddingBottom = function(n) {
            return arguments.length ? (s = "function" == typeof n ? n : Wo(+n),
            t) : s
        }
        ,
        t.paddingLeft = function(n) {
            return arguments.length ? (l = "function" == typeof n ? n : Wo(+n),
            t) : l
        }
        ,
        t
    ...
    t.arc = function() {
        function t() {
            var t, c, s = +n.apply(this, arguments), l = +e.apply(this, arguments), h = o.apply(this, arguments) - T_, d = a.apply(this, arguments) - T_, p = g_(d - h), v = d > h;
            if (f || (f = t = oe()),
            l < s && (c = l,
            l = s,
            s = c),
            l > M_)
                if (p > N_ - M_)
                    ...
                    f.arc(0, 0, l, h, d, !v),
                    s > M_ && (f.moveTo(s * __(d), s * x_(d)),
                    f.arc(0, 0, s, d, h, v));
                else {
                    var g, y, _ = h, b = d, m = h, x = d, w = p, M = p, A = u.apply(this, arguments) / 2, T = A > M_ && (i ? +i.apply(this, arguments) : w_(s * s + l * l)), N = m_(g_(l - s) / 2, +r.apply(this, arguments)), S = N, E = N;
                    if (T > M_) {
                        var k = hf(T / s * x_(A))
                          , C = hf(T / l * x_(A));
                        (w -= 2 * k) > M_ ? (k *= v ? 1 : -1,
                    ...
                    M > M_ ? E > M_ ? (g = _f(q, O, P, z, l, E, v),
                    y = _f(D, U, R, L, l, E, v),
                    f.moveTo(g.cx + g.x01, g.cy + g.y01),
                    E < N ? f.arc(g.cx, g.cy, E, y_(g.y01, g.x01), y_(y.y01, y.x01), !v) : (f.arc(g.cx, g.cy, E, y_(g.y01, g.x01), y_(g.y11, g.x11), !v),
                    f.arc(0, 0, l, y_(g.cy + g.y11, g.cx + g.x11), y_(y.cy + y.y11, y.cx + y.x11), !v),
                    f.arc(y.cx, y.cy, E, y_(y.y11, y.x11), y_(y.y01, y.x01), !v))) : (f.moveTo(P, z),
                    f.arc(0, 0, l, _, b, !v)) : f.moveTo(P, z),
                    s > M_ && w > M_ ? S > M_ ? (g = _f(R, L, D, U, s, -S, v),
                    y = _f(P, z, q, O, s, -S, v),
                    f.lineTo(g.cx + g.x01, g.cy + g.y01),
                    S < N ? f.arc(g.cx, g.cy, S, y_(g.y01, g.x01), y_(y.y01, y.x01), !v) : (f.arc(g.cx, g.cy, S, y_(g.y01, g.x01), y_(g.y11, g.x11), !v),
                    f.arc(0, 0, s, y_(g.cy + g.y11, g.cx + g.x11), y_(y.cy + y.y11, y.cx + y.x11), v),
                    f.arc(y.cx, y.cy, S, y_(y.y11, y.x11), y_(y.y01, y.x01), !v))) : f.arc(0, 0, s, x, m, v) : f.lineTo(R, L)
                }
            else
                f.moveTo(0, 0);
            if (f.closePath(),
        ...
        t.padRadius = function(n) {
            return arguments.length ? (i = null == n ? null : "function" == typeof n ? n : lf(+n),
            t) : i
        }
        ,
        t.startAngle = function(n) {
            return arguments.length ? (o = "function" == typeof n ? n : lf(+n),
            t) : o
        }
        ,
        t.endAngle = function(n) {
        ...
        t.padAngle = function(n) {
            return arguments.length ? (u = "function" == typeof n ? n : lf(+n),
            t) : u
        }
        ,
        t.context = function(n) {
            return arguments.length ? (f = null == n ? null : n,
            t) : f
        }
        ,
        t
    ...
    t.pie = function() {
        function t(t) {
            var u, f, c, s, l, h = t.length, d = 0, p = new Array(h), v = new Array(h), g = +i.apply(this, arguments), y = Math.min(N_, Math.max(-N_, o.apply(this, arguments) - g)), _ = Math.min(Math.abs(y) / h, a.apply(this, arguments)), b = _ * (y < 0 ? -1 : 1);
            for (u = 0; u < h; ++u)
    ...
    t.stack = function() {
        ...
        return t.keys = function(e) {
            return arguments.length ? (n = "function" == typeof e ? e : lf(E_.call(e)),
            t) : n
        }
        ,
        t.value = function(n) {
        ...
        ,
        t.order = function(n) {
            return arguments.length ? (e = null == n ? lc : "function" == typeof n ? n : lf(E_.call(n)),
            t) : e
        }
        ,
        t.offset = function(n) {
            return arguments.length ? (r = null == n ? sc : n,
            t) : r
        }
        ,
        t
    ...
    t.voronoi = function() {
        ...
        ,
        t.x = function(e) {
            return arguments.length ? (n = "function" == typeof e ? e : vc(+e),
            t) : n
        }
        ,
        t.y = function(n) {
            return arguments.length ? (e = "function" == typeof n ? n : vc(+n),
            t) : e
        }
        ,
        t.extent = function(n) {
    ...
    t.zoom = function() {
        ...
        var p, v, g = Gc, y = Vc, _ = Qc, b = Wc, m = Zc, x = [0, 1 / 0], w = [[-1 / 0, -1 / 0], [1 / 0, 1 / 0]], M = 250, A = _n, T = [], S = N("start", "zoom", "end"), E = 500, k = 150, C = 0;
        ...
        n.wheelDelta = function(t) {
            return arguments.length ? (b = "function" == typeof t ? t : Fc(+t),
            n) : b
        }
        ,
        n.filter = function(t) {
            return arguments.length ? (g = "function" == typeof t ? t : Fc(!!t),
            n) : g
        }
        ,
        n.touchable = function(t) {
            return arguments.length ? (m = "function" == typeof t ? t : Fc(!!t),
            n) : m
        }
        ,
        n.extent = function(t) {
            return arguments.length ? (y = "function" == typeof t ? t : Fc([[+t[0][0], +t[0][1]], [+t[1][0], +t[1][1]]]),
            n) : y
        }
        ,
        n.scaleExtent = function(t) {
            return arguments.length ? (x[0] = +t[0],
            x[1] = +t[1],
            n) : [x[0], x[1]]
        }
        ,
